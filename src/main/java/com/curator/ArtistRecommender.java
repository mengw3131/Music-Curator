 ...
 *         a SongRecommender instance. The list of recommended songs from that
...
public class ArtistRecommender {
	...
	HashMap<Song, Double> userSongRecs; // stores songs from the Spotify
	 ...
	 *         an instance of SongRecommender
	 */
	public HashMap<Song, Double> getUserSongRecs() {
		return userSongRecs;
	}
	 ...
	 * songs as an input to SongRecommender. Retrieves the song recommendations
	 * from SongRecommender. Stores these results in userSongRecs. Calculates
	 ...
	 * @param userSongRecs    The list of songs from SongRecommender
