 ...
 *         com.curator.recommender.SongRecommender instance. The list of recommended songs from that
...
public class AlbumRecommender {
	...
	HashMap<Artist, Double> userArtistRecs; // stores recommended artists and
											...
											// com.curator.recommender.ArtistRecommender
	 ...
	 *         similarity scores generated by an instance of com.curator.recommender.ArtistRecommender
	 */
	 ...
	 * songs as an input to com.curator.recommender.ArtistRecommender. Retrieves the artist
	 * recommendations from com.curator.recommender.ArtistRecommender. Creates a list of recommended
	 * albums based on the recommended artists (most popular albums by the
	 * recommended artists).
	 * 
	 * @param userAlbumLikes The list of user provided artists
	 * @param userArtistRecs The list of artists from com.curator.recommender.ArtistRecommender
