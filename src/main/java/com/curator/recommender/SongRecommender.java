...
public class SongRecommender {
    ...
    ArrayList<AudioFeatures> audioFeaturesPool = new ArrayList<>(); // stores the narrowed-down
    ...
    public void searchByRelatedArtists() {
        ...
        poolingSongs: for (ArrayList<Artist> list : relatedArtists) {
            int artistCount = 0;
        ...
        //after song pool is initialized, fill its corresponding audio feature pool
    ...
    public void fillAudioFeaturePool() {
        ...
        audioFeaturesPool.addAll(SpotifyTools.getSeveralAudioFeaturesFromTracks(songPool));
     ...
     */
    public double generateSimilarityScore(AudioFeatures af) {
        ...
        double loudScore = (af.getLoudness()
